# Support for Output Descriptors in Watacoin Core

Since Watacoin Core v0.17, there is support for Output Descriptors. This is a
...
on Watacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Watacoin Core wallets, a convenience function `combo` is
