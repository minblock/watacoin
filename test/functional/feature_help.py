...
"""Verify that starting watacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start watacoin with -h for help text")
        ...
        self.log.info("Start watacoin with -version for version information")
        ...
        self.log.info("Start watacoind with -fakearg to make sure it does not start")
