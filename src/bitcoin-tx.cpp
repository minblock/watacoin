...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " watacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  watacoin-tx [options] <hex-tx> [commands]  Update hex-encoded watacoin transaction\n" +
            "or:     watacoin-tx [options] -create [commands]   Create hex-encoded watacoin transaction\n" +
            "\n";
